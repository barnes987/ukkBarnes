...
public class AdapterSPPData extends RecyclerView.Adapter <com.example.ukk.AdapterSPPData.SPPViewHolder> {
    Context mcontext;
    List<ModelSPP> mspp;
    ...
    public class SPPViewHolder extends RecyclerView.ViewHolder {
        ...
        public SPPViewHolder(@NonNull View itemView) {
            super(itemView);
            mView = itemView;
            tahunp = (TextView)itemView.findViewById(R.id.texttahun);
            nominalp = (TextView)itemView.findViewById(R.id.textnominal);
