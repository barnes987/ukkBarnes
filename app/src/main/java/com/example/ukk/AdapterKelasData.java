...
import com.example.ukk.DataPetugas;
import com.example.ukk.ModelKelas;
...
public class AdapterKelasData extends RecyclerView.Adapter <com.example.ukk.AdapterKelasData.KelasViewHolder> {
    Context mcontext;
    ...
    public void onBindViewHolder(@NonNull AdapterKelasData.KelasViewHolder holder, int position) {
        ...
        holder.ubahk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(mcontext, DataPetugas.class);
    ...
    public class KelasViewHolder extends RecyclerView.ViewHolder {
        ...
        public KelasViewHolder(@NonNull View itemView) {
            super(itemView);
            mView = itemView;
            namak = (TextView) itemView.findViewById(R.id.textkelas);
            deletek = (ImageView) itemView.findViewById(R.id.buttondeletekelas);
            dRef = FirebaseDatabase.getInstance().getReference("Kelas");
            ubahk = (ImageView) itemView.findViewById(R.id.buttonubahkelas);
        }
